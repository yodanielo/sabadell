    ...
    function formulario() {
        ...
        $m_Form->controles=array(
            ...
            array("label"=>"Banner:","campo"=>"imgmenu","tipo"=>"archivogg",
                "tooltip"=>"Formatos permitidos: jpg, png, gif, swf",
                "extensiones"=>"*.jpg; *.png; *.gif; *.swf",
                "descripcion"=>"Archivos de Imágenes, Archivos Flash",
                ),
            array("label"=>"Altura<br/>Solo para flash","campo"=>"imgalto"),
        );
        $res = $m_Form->ver();
        return  $res;
    }
